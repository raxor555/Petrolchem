    ...
    <section className="bg-white border-t border-gray-100">
      <div className="grid grid-cols-1 lg:grid-cols-3">
        ...
        <div className="bg-[#1b0a05] p-10 md:p-24 flex flex-col justify-center relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-48 md:w-64 h-48 md:h-64 bg-[#E83E00]/10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-110 transition-transform duration-1000"></div>
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl text-white font-semibold mb-8 md:mb-10 leading-[1.1] uppercase tracking-tight">
              Pioneer your <br /> <span className="text-[#E83E00]">Future</span> at <br /> Petrolchem
            </h2>
            <button 
              onClick={scrollToContact}
              className="bg-[#E83E00] text-white w-full sm:w-auto px-10 py-5 font-semibold text-[11px] md:text-[12px] tracking-[0.3em] uppercase hover:bg-white hover:text-[#E83E00] transition-all shadow-2xl"
            >
              JOIN OUR NETWORK
            </button>
          </div>
          <div className="absolute bottom-10 right-10 grid grid-cols-4 gap-3 md:gap-4 opacity-20">
            {Array.from({ length: 16 }).map((_, i) => (
              <div key={i} className="w-1 md:w-1.5 h-1 md:h-1.5 bg-[#E83E00] rounded-full"></div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:col-span-2 relative min-h-[400px] md:min-h-[600px] bg-cover bg-center flex items-end p-8 md:p-24 group overflow-hidden"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#1b0a05] via-black/30 to-transparent group-hover:from-[#E83E00]/60 transition-all duration-700"></div>
          <div className="relative z-10 w-full">
            <div className="relative pl-5 md:pl-6 mb-8 md:mb-10 border-l-4 border-[#E83E00]">
            ...
            <div className="flex items-center gap-4 md:gap-6 text-white">
              <button 
                ...
                className="w-14 h-14 md:w-20 md:h-20 rounded-full bg-[#E83E00] flex items-center justify-center group/play hover:scale-110 transition-all shadow-[0_0_30px_rgba(232,62,0,0.6)]"
              >
