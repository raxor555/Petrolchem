      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
          <div className="relative order-2 lg:order-1 group">
            <div className="absolute -top-10 -left-10 md:-top-14 md:-left-14 w-40 md:w-56 h-40 md:h-56 bg-[#E83E00]/10 rounded-full z-0 group-hover:scale-150 transition-transform duration-1000"></div>
            ...
            <div className="absolute -bottom-8 -right-8 md:-bottom-12 md:-right-12 bg-[#E83E00] p-8 md:p-14 text-white z-20 shadow-2xl rounded-sm">
          ...
          <div className="flex flex-col order-1 lg:order-2">
            <span className="text-[#E83E00] font-semibold tracking-[0.5em] text-xs md:text-base mb-6 md:mb-8 uppercase flex items-center gap-4">
              <span className="w-8 md:w-12 h-1 bg-[#E83E00]"></span> Superior Intelligence
            </span>
            <h2 className="text-4xl md:text-7xl lg:text-9xl font-semibold text-slate-900 mb-8 md:mb-16 tracking-tighter leading-[1.1] md:leading-[0.8] uppercase">
              RECODING <br /> <span className="text-[#E83E00]">THE CORE</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-14 mb-10 md:mb-20">
              <div className="border-l-4 md:border-l-8 border-[#E83E00] pl-6 md:pl-8 transition-all hover:bg-orange-50/50 py-2">
              ...
              <div className="border-l-4 md:border-l-8 border-slate-100 hover:border-[#E83E00] pl-6 md:pl-8 transition-all hover:bg-orange-50/50 py-2">
            ...
            <button 
              ...
              className="self-start px-12 md:px-24 py-4 md:py-6 bg-[#E83E00] text-white font-semibold tracking-[0.4em] text-[10px] md:text-xs hover:bg-black transition-all shadow-xl uppercase"
            >
              EXPLORE OUR LINEAGE
            </button>
          </div>
