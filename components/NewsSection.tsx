    ...
    <section className="bg-slate-50 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative min-h-[450px] md:min-h-[650px] flex flex-col justify-end px-6 md:px-16 py-16 md:py-28 bg-cover bg-center group"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#E83E00] via-black/60 to-black/20 group-hover:via-[#E83E00]/40 transition-all duration-700"></div>
          <div className="relative z-10 max-w-2xl">
            <div className="relative pl-6 md:pl-8 mb-8 md:mb-10">
              <div className="absolute left-0 top-0 bottom-0 w-1.5 md:w-2 bg-[#E83E00] shadow-[0_0_15px_rgba(232,62,0,0.8)]"></div>
              <div className="absolute left-0 top-0 w-10 md:w-12 h-1.5 md:h-2 bg-[#E83E00] shadow-[0_0_15px_rgba(232,62,0,0.8)]"></div>
            ...
            <button className="bg-white text-[#E83E00] px-8 md:px-10 py-4 font-semibold text-[11px] md:text-[12px] tracking-[0.3em] uppercase hover:bg-[#E83E00] hover:text-white transition-all shadow-2xl">
        ...
        <div className="p-8 md:p-16 lg:p-28 flex flex-col justify-center bg-[#1b0a05] text-white">
          <div className="flex items-center gap-4 mb-10 md:mb-12">
             <div className="w-8 md:w-12 h-1 bg-[#E83E00]"></div>
          ...
          <div className="space-y-6 md:space-y-10 mb-10 md:mb-12">
            {[
              ...
              <div key={idx} className="flex gap-4 md:gap-6 items-start group cursor-pointer border-b border-white/5 pb-4 md:pb-6">
                <Newspaper className="text-[#E83E00] flex-shrink-0 mt-1 w-[18px] h-[18px] md:w-5 md:h-5" />
                <p className="text-sm md:text-lg text-orange-100 font-normal group-hover:text-white group-hover:translate-x-2 transition-all leading-snug">
                  {news}
                </p>
              </div>
            ))}
          </div>
          <a href="#" className="text-[#E83E00] text-[11px] md:text-[12px] font-semibold tracking-[0.4em] uppercase flex items-center gap-3 hover:translate-x-4 transition-all w-fit">
