...
interface CMWPageProps {
  onNavigate: (page: 'home' | 'production' | 'cmw' | 'downstream') => void;
}

const CMWPage: React.FC<CMWPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      ...
      <section className="relative py-32 md:py-48 flex items-center bg-black overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#1b0a05] via-[#1b0a05]/40 to-transparent"></div>
        
        <div className="relative container mx-auto px-8 lg:px-20 z-10">
          <div className="max-w-4xl relative pl-10 md:pl-24">
            <div className="absolute left-0 top-0 w-2 md:w-3 h-24 md:h-48 bg-[#e37249] shadow-[0_0_30px_rgba(227,114,73,0.5)]"></div>
            <div className="absolute left-0 top-0 w-20 md:w-40 h-1.5 md:h-2 bg-[#e37249] shadow-[0_0_30px_rgba(227,114,73,0.5)]"></div>
            
            <h1 className="text-5xl md:text-8xl font-semibold text-white uppercase tracking-tight leading-[1.1] mb-8">
              CM&W <br /> <span className="text-[#e37249]">Solutions</span>
            </h1>
            <p className="text-xl md:text-3xl text-orange-50 font-normal max-w-3xl leading-relaxed">
      ...
      <section className="py-24 md:py-36 bg-white">
        <div className="container mx-auto px-8 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-start">
            <div>
              <span className="text-[#e37249] font-semibold tracking-[0.4em] text-sm uppercase mb-6 block">Strategic Localization</span>
              <h2 className="text-4xl md:text-6xl font-semibold text-slate-900 mb-8 tracking-tight uppercase leading-[1.1]">
                Forged for the <br /> <span className="text-[#e37249]">Kingdom’s Vision</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div className="bg-[#fffbf9] p-12 border-t-8 border-[#e37249] shadow-2xl">
                <Zap size={40} className="text-[#e37249] mb-6" />
                ...
                <ul className="space-y-4 text-slate-500 font-normal">
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Drilling Enhancements</li>
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Cementing Solutions</li>
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Stimulation Agents</li>
                </ul>
              </div>
              <div className="bg-[#fffbf9] p-12 border-t-8 border-[#e37249] shadow-2xl">
                <Droplets size={40} className="text-[#e37249] mb-6" />
                <h3 className="font-semibold text-xl mb-4 uppercase tracking-tight">Midstream</h3>
                <ul className="space-y-4 text-slate-500 font-normal">
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Production Chem</li>
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Water Remediation</li>
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Industrial Sanitation</li>
                  <li className="flex items-center gap-3"><span className="w-2 h-2 bg-[#e37249] rounded-full"></span> Pipeline Lifecycle</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      {/* Manufacturing & Blending Section */}
      <section className="py-24 md:py-44 bg-[#fffbf9] overflow-hidden">
        <div className="container mx-auto px-8 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-32 items-center">
            <div className="order-2 lg:order-1 relative group">
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-[#e37249]/10 rounded-full z-0 group-hover:scale-125 transition-transform duration-1000"></div>
              <img 
              ...
              />
              <div className="absolute -bottom-10 -right-10 bg-[#e37249] text-white p-12 z-20 shadow-2xl rounded-sm">
            ...
            <div className="order-1 lg:order-2">
              <span className="text-[#e37249] font-semibold tracking-[0.4em] text-sm uppercase mb-6 block">Confidentiality & Quality</span>
              <h2 className="text-4xl md:text-7xl font-semibold text-slate-900 mb-8 tracking-tight uppercase leading-[1.1]">
                Toll Blending <br /> <span className="text-[#e37249]">& Manufacturing</span>
              </h2>
              ...
              <button 
                ...
                className="bg-black text-white px-12 py-5 font-semibold text-xs tracking-[0.3em] uppercase hover:bg-[#e37249] transition-all shadow-xl"
              >
        ...
        <div className="container mx-auto px-8 lg:px-20">
          <div className="flex flex-col items-center text-center mb-20">
            <h2 className="text-4xl md:text-7xl font-semibold text-slate-900 mb-6 tracking-tight uppercase leading-none">
              Strategic <span className="text-[#e37249]">Logistics Hub</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-stretch">
            <div className="flex flex-col">
              ...
              />
              <div className="bg-[#fffbf9] p-12 flex-grow border-l-8 border-[#e37249] shadow-xl">
                <h4 className="text-2xl font-semibold mb-6 uppercase tracking-tight text-[#e37249]">Facility Intelligence</h4>
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    <ShieldAlert size={24} className="text-[#e37249] flex-shrink-0" />
                  ...
                  <li className="flex gap-4">
                    <Warehouse size={24} className="text-[#e37249] flex-shrink-0" />
            ...
            <div className="flex flex-col">
              <div className="bg-[#1b0a05] p-14 text-white mb-10 rounded-2xl shadow-3xl relative overflow-hidden flex-grow flex flex-col justify-center">
                <div className="absolute top-0 right-0 w-48 h-48 bg-[#e37249]/20 rounded-full translate-x-1/2 -translate-y-1/2"></div>
                <span className="text-[#e37249] font-semibold tracking-[0.4em] text-xs uppercase mb-12 block">Capacity Metrics</span>
                
                <div className="space-y-16">
                  <div className="flex items-end gap-8">
                    <span className="text-7xl md:text-9xl font-semibold text-white leading-none tracking-tighter">2,880</span>
                    <div className="pb-3">
                      <p className="text-[#e37249] font-semibold uppercase text-sm">Units</p>
                      <p className="text-orange-100 font-normal text-sm">55gal Drum Storage</p>
                    </div>
                  </div>
                  
                  <div className="flex items-end gap-8">
                    <span className="text-7xl md:text-9xl font-semibold text-[#e37249] leading-none tracking-tighter">320KL</span>
                    <div className="pb-3">
                      <p className="text-white font-semibold uppercase text-sm">Total Bulk</p>
                      <p className="text-orange-100 font-normal text-sm">In 4x 80KL Reinforced Tanks</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Contact CTA */}
      <section className="py-24 bg-[#e37249] text-white">
        <div className="container mx-auto px-8 lg:px-20 text-center">
          ...
          <p className="text-orange-100 text-xl font-normal mb-12 max-w-2xl mx-auto leading-relaxed">
            Partner with Petrolchem to elevate your chemical manufacturing and storage performance. Our teams are ready to deploy.
          </p>
          <button 
            onClick={scrollToContact}
            className="bg-white text-[#e37249] px-16 py-6 font-semibold text-sm tracking-[0.4em] uppercase hover:bg-black hover:text-white transition-all shadow-[0_20px_60px_rgba(0,0,0,0.3)]"
          >
