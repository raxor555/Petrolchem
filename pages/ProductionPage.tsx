    ...
    <div className="animate-in fade-in duration-700 bg-white">
      ...
      <section className="relative py-32 md:py-56 bg-black overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-20">
          <div className="max-w-4xl border-l-8 border-[#4B1771] pl-8 md:pl-16">
            <span className="text-[#4B1771] font-bold tracking-[0.4em] text-xs md:text-sm uppercase mb-6 block">Business Segment</span>
            <h1 className="text-5xl md:text-9xl font-semibold text-white uppercase tracking-tighter leading-none mb-10">
              Production <br /> <span className="text-[#4B1771]">Solutions</span>
            </h1>
            <p className="text-xl md:text-3xl text-purple-50 font-light max-w-2xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
            <div>
              <h2 className="text-4xl md:text-7xl font-semibold text-slate-900 mb-10 tracking-tight uppercase leading-none">
                Optimizing the <br /> <span className="text-[#4B1771]">Lifecycle</span>
              </h2>
              <div className="w-24 h-2 bg-[#4B1771] mb-12"></div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {[
                  { icon: <Settings className="text-[#4B1771]" />, title: "Artificial Lift", desc: "Advanced ESP and gas lift optimization." },
                  { icon: <Droplets className="text-[#4B1771]" />, title: "Fluid Management", desc: "Chemical solutions for separation and flow." },
                  { icon: <Zap className="text-[#4B1771]" />, title: "Power Systems", desc: "On-site energy generation and efficiency." },
                  { icon: <Shield className="text-[#4B1771]" />, title: "Asset Integrity", desc: "Corrosion and scale inhibition strategies." }
                ].map((item, i) => (
                  <div key={i} className="p-8 bg-slate-50 border-b-4 border-transparent hover:border-[#4B1771] transition-all group">
            ...
            <div className="relative">
              <img 
                ...
                alt="Production Site"
              />
              <div className="absolute -bottom-10 -left-10 bg-[#4B1771] text-white p-12 hidden md:block">
      ...
      {/* Case Study Grid */}
      <section className="py-24 md:py-44 bg-[#fbf9ff]">
        ...
        <div className="container mx-auto px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-12">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white p-10 shadow-2xl hover:-translate-y-4 transition-all duration-500 flex flex-col group">
              <span className="text-[#4B1771] font-bold text-xs tracking-widest uppercase mb-6 block">Case Study 0{i}</span>
              ...
              <a href="#" className="flex items-center gap-3 text-[#4B1771] font-bold text-xs tracking-[0.3em] uppercase group-hover:gap-5 transition-all">
      ...
      {/* Document Downloads */}
      <section className="py-24 bg-[#1a0828]">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="bg-white p-12 md:p-20 shadow-3xl flex flex-col md:flex-row justify-between items-center gap-12">
            ...
            <button className="bg-[#4B1771] text-white px-12 py-6 font-bold text-sm tracking-widest uppercase flex items-center gap-4 hover:bg-black transition-all">
