...
interface DownstreamPageProps {
  onNavigate: (page: 'home' | 'production' | 'cmw' | 'downstream') => void;
}

const DownstreamPage: React.FC<DownstreamPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="animate-in fade-in duration-1000">
      ...
      <section className="relative min-h-[60vh] flex items-center bg-[#140804] overflow-hidden py-32 md:py-48">
        <img 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#140804] via-[#140804]/60 to-transparent"></div>
        ...
        <div className="relative container mx-auto px-8 lg:px-20 z-10">
          <div className="max-w-5xl relative pl-10 md:pl-24">
            ...
            <p className="text-lg md:text-2xl text-orange-100/90 font-normal max-w-3xl leading-relaxed mb-12">
      ...
      <section className="py-24 md:py-36 bg-[#1b0a05] relative overflow-hidden">
        ...
        <div className="container mx-auto px-8 lg:px-20 text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <button onClick={scrollToContact} className="bg-transparent border-2 border-white/20 text-white px-16 py-6 font-semibold text-sm tracking-[0.4em] uppercase hover:bg-white hover:text-black transition-all w-full md:w-auto">
              VIEW CASE STUDIES
            </button>
          </div>
        </div>
